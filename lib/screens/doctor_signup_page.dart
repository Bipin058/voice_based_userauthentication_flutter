...
class _DoctorSignupPageState extends State<DoctorSignupPage> {
  ...
  Future<void> _sendDataToBackend(String doctorID, List<String> audioFiles) async {
    final uri = Uri.parse('http://192.168.1.67:5000/signin');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to send data to backend: ${response.reasonPhrase}');
      }
    } catch (e) {
