...
class _DoctorLoginPageState extends State<DoctorLoginPage> {
  ...
  final TextEditingController _doctorIdController = TextEditingController(); // Add this controller for doctor ID input
  ...
  Future<bool> _sendAudioFileToServer(String doctorId, String filePath) async {
    try {
      ...
      request.fields['test_speaker'] = doctorId; // Using the doctor ID as the speaker identifier
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              TextField(
                controller: _doctorIdController, // Add this TextField for doctor ID input
